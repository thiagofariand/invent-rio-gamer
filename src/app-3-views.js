  ...
  <div class="home-grid">
    <section class="panel panel-trend" aria-labelledby="h-trend">
      ...
      <div class="panel-body">
        <div class="cards3">${top.map(t=>`<article class="card"><div class="igdb-cover-slot" data-igdb-cover data-igdb-title="${esc(t.title)}">${coverTile(t.short,{})}</div>
