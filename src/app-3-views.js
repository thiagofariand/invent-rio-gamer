...
function renderGames(){
  ...
  main.innerHTML=`<div class="games-directory">
    ...
    <section class="ecosystem-card eco-retro" aria-label="Retrogaming"><div class="ecosystem-visual"><img class="ecosystem-retro-art" src="/assets/retro-gaming-tv.svg?v=retro-white-icon-20260925" alt=""></div><div class="ecosystem-links">${linkList(retroUniverses,5)}</div></section>
