...
export function parseRoute(hash = window.location.hash) {
  ...
  if (parts[0] === 'games') return { name:'games', params:{} };
  if (parts[0] === 'universo' && parts[1]) return { name:'universe', params:{ slug:parts[1] } };
  if (parts[0] === 'jogo' && parts[1]) return { name:'game', params:{ slug:parts[1] } };
  if (parts[0] === 'inventario') return { name:'inventory', params:{} };
