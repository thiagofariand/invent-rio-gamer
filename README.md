...
- **Cânone visual recuperado das versões 0.98/0.99:** header compacto com logo + busca + navegação, conteúdo central de ~1200 px, poucos arredondamentos, cards densos e heroes mais baixos.
...
A Home preserva a composição `Em alta` à esquerda e `Games e ofertas` + `Merch & fan-made` à direita. O Universo usa hero compacto + abas + grade de jogos imediatamente visível. A página de jogo usa hero horizontal baixo, com gradiente escuro prolongado na área do texto, seguido por um bloco comercial unificado e módulos menores de merch/fan-made.
