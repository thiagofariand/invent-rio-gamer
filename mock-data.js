...
window.INV_MOCK=(function(){
  ...
  const items=[
    ...
    {id:'mock-pikachu-pelucia',cat:'colecionaveis',type:'figure',origin:'oficial',unique:false,universe:'pokemon',title:'Pelúcia Pikachu',subtitle:'Colecionável oficial · Pokémon Center',price:149.9},
    {id:'mock-pokemon-tcg-booster',cat:'colecionaveis',type:'livro',origin:'oficial',unique:false,universe:'pokemon',title:'Box de boosters Pokémon TCG',subtitle:'Colecionável oficial · card game',price:349.9},
