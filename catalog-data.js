...
const trendingNow=[
  ...
  {title:"Marvel's Spider-Man 2",tag:'EXCLUSIVO PS5',copy:'Lançado em 20/10/2023, PS5. Desenvolvido pela Insomniac Games.',query:'marvels spider man 2 ps5',digital:'https://www.playstation.com/pt-br/games/marvels-spider-man-2/'},
...
const franchiseDirectory={
  Nintendo:['Mario','The Legend of Zelda','Pokémon','Metroid','Kirby','Donkey Kong','Animal Crossing','Fire Emblem','Splatoon','Pikmin',"Luigi's Mansion",'Captain Toad','Princess Peach'],
...
const collections={
  mario:{name:'Mario',short:'Mario',icon:'★',items:[
    {slug:'mario-kart-world',title:'Mario Kart World',year:2025,platforms:['Switch 2']},
    {slug:'mario-kart-8-deluxe',title:'Mario Kart 8 Deluxe',year:2017,platforms:['Switch']},
    {slug:'super-mario-party-jamboree',title:'Super Mario Party Jamboree',year:2024,platforms:['Switch','Switch 2']},
    {slug:'super-mario-odyssey',title:'Super Mario Odyssey',year:2017,platforms:['Switch']},
    {slug:'super-mario-3d-world-bowsers-fury',title:"Super Mario 3D World + Bowser's Fury",year:2021,platforms:['Switch']},
    {slug:'super-mario-bros-wonder',title:'Super Mario Bros. Wonder',year:2023,platforms:['Switch','Switch 2']},
    {slug:'mario-vs-donkey-kong',title:'Mario vs. Donkey Kong',year:2024,platforms:['Switch']},
    {slug:'super-mario-maker-2',title:'Super Mario Maker 2',year:2019,platforms:['Switch']},
    {slug:'mario-golf-super-rush',title:'Mario Golf: Super Rush',year:2021,platforms:['Switch']},
    {slug:'super-mario-3d-all-stars',title:'Super Mario 3D All-Stars',year:2020,platforms:['Switch']},
    {slug:'super-mario-galaxy-1-2',title:'Super Mario Galaxy + Super Mario Galaxy 2',year:2025,platforms:['Switch','Switch 2']}
  ]},
  luigismansion:{name:"Luigi's Mansion",short:"Luigi's Mansion",icon:'☾',items:[
    {slug:'luigis-mansion-3',title:"Luigi's Mansion 3",year:2019,platforms:['Switch']}
  ]},
  captaintoad:{name:'Captain Toad',short:'Captain Toad',icon:'◆',items:[
    {slug:'captain-toad-treasure-tracker',title:'Captain Toad: Treasure Tracker',year:2018,platforms:['Switch']}
  ]},
  princesspeach:{name:'Princess Peach',short:'Princess Peach',icon:'♛',items:[
    {slug:'princess-peach-showtime',title:'Princess Peach: Showtime!',year:2024,platforms:['Switch']}
  ]},
  zelda:{name:'The Legend of Zelda',short:'Zelda',icon:'✦',items:[
    ...
    {slug:'ocarina-of-time-remake',title:'The Legend of Zelda: Ocarina of Time (2026)',year:2026,platforms:['Switch 2']},
  ...
  cod:{name:'Call of Duty',short:'Call of Duty',icon:'◎',items:[
    ...
    {slug:'black-ops-cold-war',title:'Call of Duty: Black Ops Cold War',year:2020,platforms:['PS4','PS5']},
    {slug:'vanguard',title:'Call of Duty: Vanguard',year:2021,platforms:['PS4','PS5']},
    {slug:'modern-warfare-ii-2022',title:'Call of Duty: Modern Warfare II',year:2022,platforms:['PS4','PS5']},
    {slug:'modern-warfare-iii-2023',title:'Call of Duty: Modern Warfare III',year:2023,platforms:['PS4','PS5']},
    {slug:'black-ops-7',title:'Call of Duty: Black Ops 7',year:2025,platforms:['PS4','PS5']},
    {slug:'modern-warfare-4',title:'Call of Duty: Modern Warfare 4',year:2026,platforms:['PS5']}
  ]},
  ...
  marvelspiderman:{name:'Marvel Spider-Man',short:'Spider-Man',icon:'✦',items:[
    ...
    {slug:'marvels-spider-man-2',title:"Marvel's Spider-Man 2",year:2023,platforms:['PS5']}
  ]},
  residentevil:{name:'Resident Evil',short:'Resident Evil',icon:'☣',items:[
    ...
    {slug:'resident-evil-2-remake',title:'Resident Evil 2 (2019)',year:2019,platforms:['PS4','PS5']},
    {slug:'resident-evil-3-remake',title:'Resident Evil 3 (2020)',year:2020,platforms:['PS4','PS5']},
    {slug:'resident-evil-requiem',title:'Resident Evil Requiem',year:2026,platforms:['PS5']},
    {slug:'resident-evil-revelations',title:'Resident Evil Revelations',year:2017,platforms:['PS4']},
    {slug:'resident-evil-revelations-2',title:'Resident Evil Revelations 2',year:2015,platforms:['PS4']}
  ]},
...
{franchise:'Call of Duty',title:'Call of Duty: Black Ops Cold War',aliases:['black ops cold war','cold war'],variants:[['PlayStation','PS4'],['PlayStation','PS5']]},
{franchise:'Call of Duty',title:'Call of Duty: Vanguard',aliases:['cod vanguard'],variants:[['PlayStation','PS4'],['PlayStation','PS5']]},
{franchise:'Call of Duty',title:'Call of Duty: Modern Warfare II',aliases:['modern warfare 2 2022','mwii 2022','mw2 2022'],variants:[['PlayStation','PS4'],['PlayStation','PS5']]},
{franchise:'Call of Duty',title:'Call of Duty: Modern Warfare III',aliases:['modern warfare 3 2023','mwiii 2023','mw3 2023'],variants:[['PlayStation','PS4'],['PlayStation','PS5']]},
{franchise:'Call of Duty',title:'Call of Duty: Black Ops 7',aliases:['black ops 7','bo7'],variants:[['PlayStation','PS4'],['PlayStation','PS5']]},
{franchise:'Call of Duty',title:'Call of Duty: Modern Warfare 4',aliases:['modern warfare 4','mw4'],variants:[['PlayStation','PS5']]},
...
{franchise:'Resident Evil',title:'Resident Evil 2 (2019)',aliases:['resident evil 2 remake','re2 remake'],variants:[['PlayStation','PS4'],['PlayStation','PS5']]},
{franchise:'Resident Evil',title:'Resident Evil 3 (2020)',aliases:['resident evil 3 remake','re3 remake'],variants:[['PlayStation','PS4'],['PlayStation','PS5']]},
{franchise:'Resident Evil',title:'Resident Evil Requiem',aliases:['re requiem','resident evil 9'],variants:[['PlayStation','PS5']]},
...
{franchise:'The Legend of Zelda',title:'The Legend of Zelda: Ocarina of Time (2026)',aliases:['ocarina of time switch 2','zelda oot switch 2','zelda oot remake'],variants:[['Nintendo','Switch 2']]},
...
{franchise:'Pokémon',title:'Pokémon Red and Blue',aliases:['pokemon red','pokemon blue','pokemon rb'],variants:[['Nintendo','Game Boy']]},
{franchise:'Pokémon',title:'Pokémon Yellow',aliases:['pokemon amarelo'],variants:[['Nintendo','Game Boy']]},
{franchise:'Pokémon',title:'Pokémon Gold and Silver',aliases:['pokemon gold','pokemon silver','pokemon gsc'],variants:[['Nintendo','Game Boy Color']]},
{franchise:'Pokémon',title:'Pokémon Crystal',aliases:['pokemon crystal'],variants:[['Nintendo','Game Boy Color']]},
{franchise:'Pokémon',title:'Pokémon Ruby and Sapphire',aliases:['pokemon ruby','pokemon sapphire','pokemon rs'],variants:[['Nintendo','Game Boy Advance']]},
{franchise:'Pokémon',title:'Pokémon FireRed and LeafGreen',aliases:['pokemon firered','pokemon leafgreen','pokemon frlg'],variants:[['Nintendo','Game Boy Advance']]},
{franchise:'Pokémon',title:'Pokémon Emerald',aliases:['pokemon emerald','pokemon esmeralda'],variants:[['Nintendo','Game Boy Advance']]},
{franchise:'Pokémon',title:'Pokémon Diamond and Pearl',aliases:['pokemon diamond','pokemon pearl','pokemon dp'],variants:[['Nintendo','DS']]},
{franchise:'Pokémon',title:'Pokémon Platinum',aliases:['pokemon platinum'],variants:[['Nintendo','DS']]},
{franchise:'Pokémon',title:'Pokémon HeartGold and SoulSilver',aliases:['pokemon heartgold','pokemon soulsilver','pokemon hgss'],variants:[['Nintendo','DS']]},
{franchise:'Pokémon',title:'Pokémon Black and White',aliases:['pokemon black','pokemon white','pokemon bw'],variants:[['Nintendo','DS']]},
{franchise:'Pokémon',title:'Pokémon Black 2 and White 2',aliases:['pokemon black 2','pokemon white 2','pokemon bw2'],variants:[['Nintendo','DS']]},
{franchise:'Pokémon',title:'Pokémon X and Y',aliases:['pokemon x','pokemon y','pokemon xy'],variants:[['Nintendo','3DS']]},
{franchise:'Pokémon',title:'Pokémon Omega Ruby and Alpha Sapphire',aliases:['pokemon omega ruby','pokemon alpha sapphire','pokemon oras'],variants:[['Nintendo','3DS']]},
{franchise:'Pokémon',title:'Pokémon Sun and Moon',aliases:['pokemon sun','pokemon moon','pokemon sm'],variants:[['Nintendo','3DS']]},
{franchise:'Pokémon',title:'Pokémon Ultra Sun and Ultra Moon',aliases:['pokemon ultra sun','pokemon ultra moon','pokemon usum'],variants:[['Nintendo','3DS']]},
{franchise:'Pokémon',title:"Pokémon: Let's Go, Pikachu! and Let's Go, Eevee!",aliases:['lets go pikachu','lets go eevee','pokemon lets go'],variants:[['Nintendo','Switch']]},
{franchise:'Pokémon',title:'Pokémon Sword and Shield',aliases:['pokemon sword','pokemon shield','pokemon swsh'],variants:[['Nintendo','Switch']]},
{franchise:'Pokémon',title:'Pokémon Brilliant Diamond and Shining Pearl',aliases:['pokemon brilliant diamond','pokemon shining pearl','pokemon bdsp'],variants:[['Nintendo','Switch']]},
{franchise:'Pokémon',title:'Pokémon Legends: Arceus',aliases:['pokemon arceus','pokemon legends arceus','pla'],variants:[['Nintendo','Switch']]},
{franchise:'Pokémon',title:'Pokémon Scarlet and Violet',aliases:['pokemon scarlet','pokemon violet','pokemon sv'],variants:[['Nintendo','Switch']]},
...
{franchise:'Mario',title:'Mario Kart World',aliases:['mario kart world','mkworld'],variants:[['Nintendo','Switch 2']]},
{franchise:'Mario',title:'Mario Kart 8 Deluxe',aliases:['mario kart 8','mk8 deluxe'],variants:[['Nintendo','Switch']]},
{franchise:'Mario',title:'Super Mario Party Jamboree',aliases:['mario party jamboree','smp jamboree'],variants:[['Nintendo','Switch'],['Nintendo','Switch 2',"Super Mario Party Jamboree: Nintendo Switch 2 Edition"]]},
{franchise:'Mario',title:'Super Mario Odyssey',aliases:['mario odyssey','smo'],variants:[['Nintendo','Switch']]},
{franchise:'Mario',title:"Super Mario 3D World + Bowser's Fury",aliases:['mario 3d world','bowsers fury','super mario 3d world'],variants:[['Nintendo','Switch']]},
{franchise:'Mario',title:'Super Mario Bros. Wonder',aliases:['mario wonder','smb wonder'],variants:[['Nintendo','Switch'],['Nintendo','Switch 2','Super Mario Bros. Wonder: Nintendo Switch 2 Edition']]},
{franchise:'Mario',title:'Mario vs. Donkey Kong',aliases:['mario vs donkey kong'],variants:[['Nintendo','Switch']]},
{franchise:'Mario',title:'Super Mario Maker 2',aliases:['mario maker 2','smm2'],variants:[['Nintendo','Switch']]},
{franchise:'Mario',title:'Mario Golf: Super Rush',aliases:['mario golf super rush'],variants:[['Nintendo','Switch']]},
{franchise:'Mario',title:'Super Mario 3D All-Stars',aliases:['mario 3d all stars','3d all stars'],variants:[['Nintendo','Switch']]},
{franchise:'Mario',title:'Super Mario Galaxy + Super Mario Galaxy 2',aliases:['mario galaxy 1 2','super mario galaxy bundle'],variants:[['Nintendo','Switch'],['Nintendo','Switch 2']]},
{franchise:"Luigi's Mansion",title:"Luigi's Mansion 3",aliases:['luigi mansion 3','luigis mansion 3'],variants:[['Nintendo','Switch']]},
{franchise:'Captain Toad',title:'Captain Toad: Treasure Tracker',aliases:['captain toad','treasure tracker'],variants:[['Nintendo','Switch']]},
{franchise:'Princess Peach',title:'Princess Peach: Showtime!',aliases:['princess peach showtime','peach showtime'],variants:[['Nintendo','Switch']]}
];
...
{platform:'NES',aliases:['nes','nintendo entertainment system']},{platform:'SNES',aliases:['snes','super nintendo']},{platform:'Game Boy',aliases:['game boy','gameboy']},{platform:'Game Boy Color',aliases:['game boy color','gbc']},{platform:'Game Boy Advance',aliases:['game boy advance','gba']},{platform:'DS',aliases:['nintendo ds','ds']},{platform:'Nintendo 64',aliases:['nintendo 64','n64']},{platform:'GameCube',aliases:['gamecube','game cube','gc']},{platform:'Wii U',aliases:['wii u','wiiu']},{platform:'Wii',aliases:['wii']},{platform:'Switch',aliases:['nintendo switch','switch']},{platform:'Switch 2',aliases:['nintendo switch 2','switch 2']},{platform:'3DS',aliases:['3ds','nintendo 3ds']},
...
const retroPlatforms=['NES','SNES','Game Boy','Game Boy Color','Game Boy Advance','DS','3DS','Nintendo 64','GameCube','Master System','Mega Drive / Genesis','Game Gear','Sega CD / Mega-CD','Saturn','Dreamcast','PS1','PS2'];

/* Plataformas em que faz sentido oferecer o bloco "Digital" (lojas atuais). */
const digitalPlatforms=['Switch','Switch 2','PS4','PS5'];
