...
async function buildOffersResponse({method,query,token}){
  ...
  if(condition==='used'){
    return {statusCode:200,cacheControl:'s-maxage=120, stale-while-revalidate=300',body:{
      title,platform:platform||null,condition,
      offers:[],nationalOffers:[],importedOffers:[],totalShown:0,
      ...
      sources:{
        mercado_livre:{
          ...
          note:'Busca de usados exige outra fonte/integração; nenhum preço é inventado.'
        }
      }
    }};
  }
